...
![Figure 9.1: Structure of a neuron ](image/B15737_09_1.jpg)
...
![Figure 9.3: The various layers of an ANN ](image/B15737_09_3.jpg)
...
![Figure 9.4: Output of the neurons ](image/B15737_09_4.jpg)
...
![Figure 9.5: Representation of activation functions ](image/B15737_09_5.jpg)
...
![Figure 9.6: The weight adjustment procedure ](image/B15737_09_6.jpg)
...
2.  Now we can import the dataset. This is available in `.dat` format, and, to make your job easier, it has already been downloaded and is available in this book's GitHub repository:
    ...
    ![Figure 9.7: DataFrame output ](image/B15737_09_7.jpg)
...
![Figure 9.8: Basic statistics of the DataFrame ](image/B15737_09_8.jpg)
...
1.  To start, we will draw a boxplot, as follows:
    ...
    ![Figure 9.10: Boxplot of the DataFrame ](image/B15737_09_10.jpg)
...
![Figure 9.13: Scatterplots of the neural network models ](image/B15737_09_13.jpg)
...
基于 LSTM 的模型包含链接在一起的单元，称为 LSTM 块。每个单元提供三种类型的端口：输入门、输出门和忘记门。这些端口分别在单元内存上执行写入、读取和重置功能。这些端口为模拟端口，由[0,1]范围内的 sigmoid 激活函数控制。这里，0 表示完全抑制，1 表示完全激活。这些端口允许 LSTM 单元在未指定的时间内记住信息。
