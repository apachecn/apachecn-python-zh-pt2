...
![](images/bcac4b05-7da8-4f20-80dc-0e60012de2e2.png)

这个公式告诉我们，我们将对所有观测值对的秩![](images/a6ca8ca4-d560-4138-a5f1-ccf8cdb5c293.png)和![](images/5565831b-1957-4b87-8f42-9b09908af421.png)的差异求和。Python 版本取决于`sum()`和`len()`函数，如下所示：
