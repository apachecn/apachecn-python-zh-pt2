...
![Figure 10.1 – Flowchart of first roll scores ](image/Figure_10.1_B15413.jpg)

图 10.1——第一轮得分流程图

从流程图中可以看出，分数取决于卷数。现在，假设您已滚动了一个**1**。然后，让我们来看看下面的图表中你的第二卷会是什么样子：

![Figure 10.2 – Flowchart of the second roll after rolling 1 ](image/Figure_10.2_B15413.jpg)
...
![Figure 10.3 – Python range interpretation with one argument ](image/Figure_10.3_B15413.jpg)
...
![Figure 10.4 – User input in function with three arguments ](image/Figure_10.4_B15413.jpg)
