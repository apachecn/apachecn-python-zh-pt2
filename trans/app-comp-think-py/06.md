...
![Figure 6.1 – Design thinking model ](image/Figure_6.1_B15413.jpg)
...
![Figure 6.2 – Brainstorm diagram  ](image/Figure_6.02_B15413.jpg)
...
![Figure 6.3 – Flowchart for one element of the survey ](image/Figure_6.3_B15413.jpg)

图 6.3–调查一个要素的流程图

正如您从流程图中所看到的，有些事情并不清晰可见，例如当您完成一个问题时会发生什么，您在每个决策后会去哪里，等等。当我创建流程图时，我有时会添加箭头，以帮助我查看每个步骤后发生的情况。以下流程图显示了添加的一些箭头：

![Figure 6.4 – Flowchart with arrows ](image/Figure_6.4_B15413.jpg)
...
![Figure 6.5 – Flowchart for pizzeria decision-making ](image/Figure_6.5_B15413.jpg)
...
![Figure 6.6 – Flowchart for traffic light game ](image/Figure_6.6_B15413.jpg)
