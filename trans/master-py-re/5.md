...
![Benchmarking regular expressions with Python](graphics/3156OS_05_01.jpg)
...
![The RegexBuddy tool](graphics/3156OS_05_02.jpg)
...
![Backtracking](graphics/3156OS_05_03.jpg)
...
例如，如果我们有`/(Hello`![Extract common parts in alternation](graphics/inlinemedia.jpg)`World|Hello`![Extract common parts in alternation](graphics/inlinemedia.jpg)`Continent|Hello`![Extract common parts in alternation](graphics/inlinemedia.jpg)`Country,)/`，我们可以很容易地用以下表达式提取`Hello`![Extract common parts in alternation](graphics/inlinemedia.jpg)：`/Hello`![Extract common parts in alternation](graphics/inlinemedia.jpg)`(World|Continent|Country)/`。这将使我们的引擎只需检查`Hello`![Extract common parts in alternation](graphics/inlinemedia.jpg)一次，而不会针对每种可能性返回重新检查。在下面的示例中，我们可以看到执行上的差异：
