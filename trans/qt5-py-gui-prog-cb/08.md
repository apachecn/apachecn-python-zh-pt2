...
![](img/7bf4b51f-8a4a-4db6-9b07-afd2791394d8.png)
...
![](img/cdc8640b-cc34-4852-8043-0f035731c30a.png)
...
![](img/3445afe4-fea6-4ed6-b2f9-a9ff57149e4e.png)
...
![](img/3c90c0aa-b97b-4f08-b20d-0f4dc11e633b.png)
...
要使球看起来像是在反弹，我们需要先使其朝向地面设置动画，然后从地面向上移动到天空。为此，我们将调用`QPropertyAnimation`类的`setKeyValueAt`方法三次。第一次和第二次调用`setKeyValueAt`方法将使球从上到下设置动画。第三次调用`setKeyValueAt`方法将使球从下至上设置动画。提供三种`setKeyValueAt`方法中的坐标，以便球在相反方向反弹，而不是从何处反弹。以下是了解如何将球设置为反弹的动画的步骤：
...
![](img/6fffbe1a-5421-4b1a-ad10-8894f5c402a2.png)
...
![](img/b6162c7c-1b81-49ca-831f-3bc35ece602d.png)
...
![](img/08cb8e3d-c254-4a17-af0a-4cc6ba5d8d6e.png)
...
![](img/b827d0f0-c54a-48d8-9cc4-b222062840bb.png)