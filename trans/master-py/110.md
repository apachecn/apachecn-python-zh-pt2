...
此外，由于使用了 Google 语法（如[第 9 章](109.html "Chapter 9. Documentation – How to Use Sphinx and reStructuredText")、*文档–如何使用 Sphinx 和重构文本*、【文档章节】中所述），我们可以使用 Sphinx 生成漂亮的文档：
