...
*   ![](assets/a2dab301-62ba-4266-8c06-d8a447eae749.png)。此定义使用扩展的向上箭头表示法进行递归求幂。
*   ![](assets/b27dff9a-420c-48f8-9e45-dee5116fed21.png)。这是以前实现的递归定义。
...
在某些情况下，很明显我们有一个涉及搜索的数据结构。我们知道，删除搜索将大大提高性能。正如我们在[第 6 章](06.html)中所看到的，*使用可调用项和上下文*，通过避免重新计算，实现记忆可以显著提高性能。
