...
![](assets/34162167-3cac-4fc6-8676-1552cfd5f1bf.png)
...
在[第 17 章](17.html)、*处理服务交易*中，将对工匠`signing_key`价值观的创建和管理（以及中央办公室与工匠之间的沟通）以及实施某种关键轮换流程的可能性进行更详细的研究。
...
![](assets/c817168b-6d30-4c6e-ae3e-b6afc0782782.png)

第二次运行脚本，然后使用`rabbitmqctl list_queues`工具，显示另一条准备就绪且正在队列中等待的消息：

![](assets/1cea8516-8d32-4bfe-bf16-3e6b40d4d652.png)
...
![](assets/0c45be17-bafa-44ee-904b-0353ab8c6c29.png)
...
![](assets/aee59828-f4b3-49d9-a3b2-341dd020bd5c.png)
...
![](assets/018a6a4a-3292-475b-8a5a-c12c3829351f.png)
...
![](assets/47cc5788-d105-4bb8-94a2-f2549d060e10.png)
...
![](assets/6e5794ea-6adf-401d-91a9-7782d7c5fd24.png)
...
![](assets/0cb06097-c8d9-4427-a023-f4fdc885b6b5.png)
...
*   `{MIME-type}`是正在传输的文件类型的指示符，例如`image/png`
